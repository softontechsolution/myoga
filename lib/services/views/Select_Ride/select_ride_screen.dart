              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        Text("Select Ride", style: Theme.of(context).textTheme.headline5, textAlign: TextAlign.center,),
                        const SizedBox(width: 10.0,),
                        SelectRide(
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (c, index){
                                    return SelectDeveryMode(
                                        ...
                                        ((tripDirectionDetails != null) ? "${AssistanceMethods.calculateFares(tripDirectionDetails!, snapshot.data![index].rate)}" : "" ),
