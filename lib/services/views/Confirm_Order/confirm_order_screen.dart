                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        title: Column(
                          ...
                          children: [
                            Chip(label: Text(packageModel.packageType.toString()),
                              backgroundColor: Colors.deepPurple,
                              labelStyle: const TextStyle(color: Colors.white),
                            ),
                            Text('Weight: ${packageModel.packageWeight} kg', style: Theme.of(context).textTheme.headline5,),
                            Text('Height: ${packageModel.packageHeight} cm', style: Theme.of(context).textTheme.headline5,),
                            Text('Width: ${packageModel.packageWidth} cm', style: Theme.of(context).textTheme.headline5,),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                OutlinedButton(onPressed: (){},
                                  ...
                                  child: Text('Payment Method: ${packageModel.paymentType}', style: Theme.of(context).textTheme.bodyText1,),
                                ),
                              ],
                            ),
                            const SizedBox(height: 10.0,),
                            Text(moAddPackageDetails, style: Theme.of(context).textTheme.headline6,),
                            const SizedBox(height: 5.0,),
                            Text(packageModel.additionalDetails??"", style: Theme.of(context).textTheme.bodyText2,),
                          ],
                        ),
                      ),
                      const SizedBox(height: 16.0,),
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            final package = PackageDetails(
                              ...
                              packageType: packageModel.packageType.toString(),
