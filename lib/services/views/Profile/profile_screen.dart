              ...
              child: Container(
                ...
                child: Column(
                  children: [
                        ...
                        child: ClipRRect(
                            ...
                            return const Center(child: CircularProgressIndicator());
                              ...
                              errorBuilder:
                                ...
                                : Image(image: NetworkImage(myUserDetail.value.profilePic??"Me"), fit: BoxFit.cover, loadingBuilder: (context,
                                child, loadingProgress) {if (loadingProgress == null) {
                              return child;
                            }
                            return const Center(child: CircularProgressIndicator());
                    ...
                    Text(myUserDetail.value.email ?? userEmail ??"My Oga", style: Theme.of(context).textTheme.bodyText2),
                    const SizedBox(height: 10.0),
                    SizedBox(
                      width: 200.0,
